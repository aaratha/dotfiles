;;; doom-gruvbox-transparent-theme.el --- inspired by morhetz's Gruvbox -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(def-doom-theme doom-gruvbox-transparent
...
;;; doom-gruvbox-transparent-theme.el ends here
