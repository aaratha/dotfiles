...
(def-doom-theme doom-solarized-transparent
                ...
                ((bg         '("#000000" "#000000" "black"      ))
                 ...
                 ;; custom categories
                 (-modeline-bright doom-solarized-transparent-brighter-modeline)
                 (-modeline-pad
                  (when doom-solarized-transparent-padded-modeline
                    (if (integerp doom-solarized-transparent-padded-modeline) doom-solarized-transparent-padded-modeline 4)))

                 (modeline-fg     'unspecified)
                 (modeline-fg-alt base5)

                 (modeline-bg "#0f1e26")
                 (modeline-bg-alt "#0f1e26")
                 (modeline-bg-inactive "#0f1e26")
                 (modeline-bg-inactive-alt "#0f1e26"))
  ...
  ;;;; Base theme face overrides
                (((font-lock-comment-face &override)
                  :slant 'italic
                  :background (if doom-solarized-transparent-brighter-comments
                                  (doom-lighten bg 0.05)
                                'unspecified))
                 (window-divider :foreground "#25343d")
