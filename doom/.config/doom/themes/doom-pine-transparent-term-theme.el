;; doom-pine-transparent-term-theme.el --- a green flavor of doom-gruvbox -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
;;
(defgroup doom-pine-transparent-term-theme nil
  "Options for doom-pine-transparent-term."
  :group 'doom-themes)

(defcustom doom-pine-transparent-term-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line. Can be an integer to
determine the exact padding."
  :group 'doom-pine-transparent-term-theme
...
(def-doom-theme doom-pine-transparent-term
  ...
  ((bg         '(nil nil  nil          )) ; bg0
   ...
   (-modeline-pad
    (when doom-pine-transparent-term-padded-modeline
      (if (integerp doom-pine-transparent-term-padded-modeline)
          doom-pine-transparent-term-padded-modeline
        4)))
...
;;; doom-pine-transparent-term-theme.el ends here
