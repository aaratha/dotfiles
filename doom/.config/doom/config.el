...
(setq org-startup-indented nil)        ; Turn off org-indent globally
...
;; Continuous scrolling for doc-view
(setq doc-view-continuous t)

;; Load org-superstar properly after org is loaded
(after! org
  ...
  (set-face-attribute 'org-document-title nil :height 1.5 :inherit 'org-level-8)

  ;; Stop cycling level faces
...
;; Configure org-superstar bullets after package loads
(after! org-superstar
  ;; Headline bullets by depth
