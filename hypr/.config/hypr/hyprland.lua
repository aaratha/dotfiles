...
hl.on("hyprland.start", function ()
  ...
  hl.exec_cmd("ghostty --class=com.mitchellh.ghostty.dropdown")
end)
...
hl.config({
    general = {
        gaps_in  = 5,
        gaps_out = {top = 0, right = 32, bottom = 32, left = 32},
        border_size = 1,

        col = {
            active_border   = { colors = {"rgba(ffffff33)", "rgba(ffffff33)"}, angle = 45 },
...
-- Default springs
hl.curve("easy",           { type = "spring", mass = 1, stiffness = 400.1191, dampening = 50.21279333 })

-- animation curve + speed for the special workspace slide-in
hl.curve("dropIn", { type = "bezier", points = { {0.16, 1}, {0.3, 1} } })
hl.animation({ leaf = "workspaces", enabled = true, speed = 5, bezier = "dropIn", style = "slidevert" })
...
local launcherBlur = hl.layer_rule({
    name = "launcher-blur",
