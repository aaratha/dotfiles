...
#+begin_src emacs-lisp
  (use-package rust-mode
    ...
    (setq rust-format-on-save t
          ...
          rust-cargo-default-arguments "--all-targets --all-features"
          rust-cargo-clippy-default-arguments '("--all-targets" "--all-features"))
    :config
    (defun ek/rust-mode-setup ()
      (setq-local prettify-symbols-alist rust-prettify-symbols-alist)
      (prettify-symbols-mode 1)
      (electric-pair-local-mode 1))

    (defun ek/rust-ts-mode-setup ()
      (setq-local prettify-symbols-alist rust-prettify-symbols-alist)
      (prettify-symbols-mode 1)
      (electric-pair-local-mode 1)
    ...
    (add-hook 'rust-mode-hook #'ek/rust-mode-setup)
    (add-hook 'rust-ts-mode-hook #'ek/rust-ts-mode-setup))
#+end_src
*** Dotenv 
#+begin_src emacs-lisp
  ;;; DOTENV
