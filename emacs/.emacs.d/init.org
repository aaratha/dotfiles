...
#+begin_src emacs-lisp
  ...
  (use-package org
    ...
    (defun my/apply-org-heading-faces (&rest _)
      ...
      (set-face-attribute 'org-level-2 nil :inherit 'fixed-pitch :weight 'bold :height 1.35)
      (set-face-attribute 'org-level-3 nil :inherit 'fixed-pitch :weight 'semi-bold :height 1.35)
      (set-face-attribute 'org-level-4 nil :inherit 'fixed-pitch :weight 'semi-bold :height 1.35)
      (set-face-attribute 'org-level-5 nil :inherit 'fixed-pitch :weight 'normal :height 1.35)
      (set-face-attribute 'org-level-6 nil :inherit 'fixed-pitch :weight 'normal :height 1.35)
      (set-face-attribute 'org-level-7 nil :inherit 'fixed-pitch :weight 'normal :height 1.35)
      (set-face-attribute 'org-level-8 nil :inherit 'fixed-pitch :weight 'normal :height 1.35))
